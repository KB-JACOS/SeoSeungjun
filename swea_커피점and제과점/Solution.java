...
class Solution {
	...
	public static void main(String[] args) throws Exception {
		...
		// int[] a = {0,2,1,1,5,4}, b = {1,0,2,3,3,5}, c={80,30,10,10,60,20};
		// usersolution.init(6, 6, a, b, c);
		// usersolution.add(3, 4, 30);
		// usersolution.printGraph();

		// int[] cafe = {0}, bakery = {5};
		// System.out.println(usersolution.calculate(1, cafe, 1, bakery, 50));

		// usersolution.add(1, 4, 30);
		// usersolution.printGraph();

		// System.out.println(usersolution.calculate(1, cafe, 1, bakery, 50));

		// int[] cafe2 = {0, 4}, bakery2 = {5, 2};
		// System.out.println(usersolution.calculate(1, cafe2, 1, bakery2, 50));
